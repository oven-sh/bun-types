[bun-types](https://oven-sh.github.io/bun-types/README.md) / [Exports](https://oven-sh.github.io/bun-types/modules.md) / ["crypto"](https://oven-sh.github.io/bun-types/modules/crypto_.md) / DecipherCCM
...
- [eventNames](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherCCM.md#eventnames)
...
When using an older Node.js library that emits `'data'` events and has a [pause](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherCCM.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherCCM.md#pipe). However, if calling `write()` is preferred, it is
