[bun-types](https://oven-sh.github.io/bun-types/README.md) / [Exports](https://oven-sh.github.io/bun-types/modules.md) / ["crypto"](https://oven-sh.github.io/bun-types/modules/crypto_.md) / DecipherOCB

# Interface: DecipherOCB

["crypto"](https://oven-sh.github.io/bun-types/modules/crypto_.md).DecipherOCB
...
- [allowHalfOpen](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#allowhalfopen)
- [destroyed](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#destroyed)
- [locked](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#locked)
- [readable](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#readable)
- [readableAborted](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#readableaborted)
- [readableEncoding](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#readableencoding)
- [readableEnded](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#readableended)
- [readableFlowing](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#readableflowing)
- [readableHighWaterMark](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#readablehighwatermark)
- [readableLength](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#readablelength)
- [readableObjectMode](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#readableobjectmode)
- [writable](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#writable)
- [writableCorked](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#writablecorked)
- [writableEnded](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#writableended)
- [writableFinished](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#writablefinished)
- [writableHighWaterMark](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#writablehighwatermark)
- [writableLength](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#writablelength)
- [writableObjectMode](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#writableobjectmode)

### Methods

- [[asyncIterator]](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#[asynciterator])
- [\_construct](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#_construct)
- [\_destroy](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#_destroy)
- [\_final](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#_final)
- [\_flush](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#_flush)
- [\_read](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#_read)
- [\_transform](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#_transform)
- [\_write](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#_write)
- [\_writev](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#_writev)
- [abort](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#abort)
- [addListener](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#addlistener)
- [cancel](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#cancel)
- [close](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#close)
- [cork](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#cork)
- [destroy](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#destroy)
- [emit](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#emit)
- [end](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#end)
- [eventNames](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#eventnames)
- [final](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#final)
- [forEach](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#foreach)
- [getMaxListeners](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#getmaxlisteners)
- [getReader](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#getreader)
- [getWriter](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#getwriter)
- [isPaused](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#ispaused)
- [listenerCount](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#listenercount)
- [listeners](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#listeners)
- [off](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#off)
- [on](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#on)
- [once](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#once)
- [pause](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#pause)
- [pipe](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#pipe)
- [pipeThrough](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#pipethrough)
- [pipeTo](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#pipeto)
- [prependListener](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#prependlistener)
- [prependOnceListener](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#prependoncelistener)
- [push](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#push)
- [rawListeners](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#rawlisteners)
- [read](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#read)
- [removeAllListeners](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#removealllisteners)
- [removeListener](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#removelistener)
- [resume](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#resume)
- [setAAD](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#setaad)
- [setAuthTag](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#setauthtag)
- [setAutoPadding](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#setautopadding)
- [setDefaultEncoding](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#setdefaultencoding)
- [setEncoding](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#setencoding)
- [setMaxListeners](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#setmaxlisteners)
- [tee](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#tee)
- [uncork](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#uncork)
- [unpipe](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#unpipe)
- [unshift](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#unshift)
- [update](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#update)
- [wrap](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#wrap)
- [write](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#write)
...
The buffered data will be flushed when either the [uncork](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#uncork) or [end](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#end) methods are called.
...
Calling the [write](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#write) method after calling [end](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#end) will raise an error.
...
Calling [read](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#read) after the `'end'` event has
...
▸ **removeAllListeners**(`event?`): [`DecipherOCB`](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md)
...
The `writable.uncork()` method flushes all data buffered since [cork](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#cork) was called.
...
using the [pipe](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#pipe) method.
...
Unlike [push](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#push) will reset the reading state appropriately,
...
▸ **wrap**(`stream`): [`DecipherOCB`](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md)

Prior to Node.js 0.10, streams did not implement the entire `stream` module API
as it is currently defined. (See `Compatibility` for more information.)

When using an older Node.js library that emits `'data'` events and has a [pause](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](https://oven-sh.github.io/bun-types/interfaces/crypto_.DecipherOCB.md#pipe). However, if calling `write()` is preferred, it is
