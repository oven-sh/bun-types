[bun-types](https://oven-sh.github.io/bun-types/README.md) / [Exports](https://oven-sh.github.io/bun-types/modules.md) / ["node:zlib"](https://oven-sh.github.io/bun-types/modules/node_zlib_.md) / InflateRaw

# Interface: InflateRaw

["node:zlib"](https://oven-sh.github.io/bun-types/modules/node_zlib_.md).InflateRaw
...
- [allowHalfOpen](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#allowhalfopen)
- [bytesRead](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#bytesread)
- [bytesWritten](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#byteswritten)
- [destroyed](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#destroyed)
- [locked](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#locked)
- [readable](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#readable)
- [readableAborted](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#readableaborted)
- [readableEncoding](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#readableencoding)
- [readableEnded](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#readableended)
- [readableFlowing](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#readableflowing)
- [readableHighWaterMark](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#readablehighwatermark)
- [readableLength](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#readablelength)
- [readableObjectMode](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#readableobjectmode)
- [shell](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#shell)
- [writable](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#writable)
- [writableCorked](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#writablecorked)
- [writableEnded](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#writableended)
- [writableFinished](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#writablefinished)
- [writableHighWaterMark](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#writablehighwatermark)
- [writableLength](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#writablelength)
- [writableObjectMode](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#writableobjectmode)

### Methods

- [[asyncIterator]](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#[asynciterator])
- [\_construct](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#_construct)
- [\_destroy](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#_destroy)
- [\_final](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#_final)
- [\_flush](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#_flush)
- [\_read](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#_read)
- [\_transform](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#_transform)
- [\_write](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#_write)
- [\_writev](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#_writev)
- [abort](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#abort)
- [addListener](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#addlistener)
- [cancel](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#cancel)
- [close](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#close)
- [cork](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#cork)
- [destroy](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#destroy)
- [emit](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#emit)
- [end](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#end)
- [eventNames](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#eventnames)
- [flush](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#flush)
- [forEach](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#foreach)
- [getMaxListeners](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#getmaxlisteners)
- [getReader](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#getreader)
- [getWriter](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#getwriter)
- [isPaused](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#ispaused)
- [listenerCount](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#listenercount)
- [listeners](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#listeners)
- [off](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#off)
- [on](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#on)
- [once](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#once)
- [pause](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#pause)
- [pipe](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#pipe)
- [pipeThrough](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#pipethrough)
- [pipeTo](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#pipeto)
- [prependListener](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#prependlistener)
- [prependOnceListener](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#prependoncelistener)
- [push](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#push)
- [rawListeners](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#rawlisteners)
- [read](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#read)
- [removeAllListeners](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#removealllisteners)
- [removeListener](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#removelistener)
- [reset](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#reset)
- [resume](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#resume)
- [setDefaultEncoding](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#setdefaultencoding)
- [setEncoding](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#setencoding)
- [setMaxListeners](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#setmaxlisteners)
- [tee](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#tee)
- [uncork](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#uncork)
- [unpipe](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#unpipe)
- [unshift](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#unshift)
- [wrap](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#wrap)
- [write](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#write)
...
▸ **addListener**(`event`, `listener`): [`InflateRaw`](https://oven-sh.github.io/bun-types/interfaces/zlib_.InflateRaw-1.md)
...
The buffered data will be flushed when either the [uncork](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#uncork) or [end](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#end) methods are called.
...
▸ **destroy**(`error?`): [`InflateRaw`](https://oven-sh.github.io/bun-types/interfaces/zlib_.InflateRaw-1.md)
...
▸ **end**(`cb?`): [`InflateRaw`](https://oven-sh.github.io/bun-types/interfaces/zlib_.InflateRaw-1.md)
...
Calling the [write](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#write) method after calling [end](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#end) will raise an error.
...
▸ **end**(`chunk`, `cb?`): [`InflateRaw`](https://oven-sh.github.io/bun-types/interfaces/zlib_.InflateRaw-1.md)
...
▸ **end**(`chunk`, `encoding?`, `cb?`): [`InflateRaw`](https://oven-sh.github.io/bun-types/interfaces/zlib_.InflateRaw-1.md)
...
▸ **off**(`eventName`, `listener`): [`InflateRaw`](https://oven-sh.github.io/bun-types/interfaces/zlib_.InflateRaw-1.md)
...
▸ **on**(`event`, `listener`): [`InflateRaw`](https://oven-sh.github.io/bun-types/interfaces/zlib_.InflateRaw-1.md)
...
▸ **once**(`event`, `listener`): [`InflateRaw`](https://oven-sh.github.io/bun-types/interfaces/zlib_.InflateRaw-1.md)
...
▸ **pause**(): [`InflateRaw`](https://oven-sh.github.io/bun-types/interfaces/zlib_.InflateRaw-1.md)
...
▸ **prependListener**(`event`, `listener`): [`InflateRaw`](https://oven-sh.github.io/bun-types/interfaces/zlib_.InflateRaw-1.md)
...
▸ **prependOnceListener**(`event`, `listener`): [`InflateRaw`](https://oven-sh.github.io/bun-types/interfaces/zlib_.InflateRaw-1.md)
...
Calling [read](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#read) after the `'end'` event has
...
▸ **removeAllListeners**(`event?`): [`InflateRaw`](https://oven-sh.github.io/bun-types/interfaces/zlib_.InflateRaw-1.md)
...
▸ **removeListener**(`event`, `listener`): [`InflateRaw`](https://oven-sh.github.io/bun-types/interfaces/zlib_.InflateRaw-1.md)
...
▸ **resume**(): [`InflateRaw`](https://oven-sh.github.io/bun-types/interfaces/zlib_.InflateRaw-1.md)
...
▸ **setDefaultEncoding**(`encoding`): [`InflateRaw`](https://oven-sh.github.io/bun-types/interfaces/zlib_.InflateRaw-1.md)
...
▸ **setEncoding**(`encoding`): [`InflateRaw`](https://oven-sh.github.io/bun-types/interfaces/zlib_.InflateRaw-1.md)
...
▸ **setMaxListeners**(`n`): [`InflateRaw`](https://oven-sh.github.io/bun-types/interfaces/zlib_.InflateRaw-1.md)
...
The `writable.uncork()` method flushes all data buffered since [cork](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#cork) was called.
...
▸ **unpipe**(`destination?`): [`InflateRaw`](https://oven-sh.github.io/bun-types/interfaces/zlib_.InflateRaw-1.md)

The `readable.unpipe()` method detaches a `Writable` stream previously attached
using the [pipe](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#pipe) method.
...
Unlike [push](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#push) will reset the reading state appropriately,
...
▸ **wrap**(`stream`): [`InflateRaw`](https://oven-sh.github.io/bun-types/interfaces/zlib_.InflateRaw-1.md)

Prior to Node.js 0.10, streams did not implement the entire `stream` module API
as it is currently defined. (See `Compatibility` for more information.)

When using an older Node.js library that emits `'data'` events and has a [pause](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](https://oven-sh.github.io/bun-types/interfaces/node_zlib_.InflateRaw-1.md#pipe). However, if calling `write()` is preferred, it is
