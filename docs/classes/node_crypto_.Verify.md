[bun-types](https://oven-sh.github.io/bun-types/README.md) / [Exports](https://oven-sh.github.io/bun-types/modules.md) / ["node:crypto"](https://oven-sh.github.io/bun-types/modules/node_crypto_.md) / Verify

# Class: Verify

["node:crypto"](https://oven-sh.github.io/bun-types/modules/node_crypto_.md).Verify
...
The [createVerify](https://oven-sh.github.io/bun-types/modules/node_crypto_.md#createverify) method is used to create `Verify` instances.`Verify` objects are not to be created directly using the `new` keyword.
...
- [constructor](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#constructor)

### Properties

- [destroyed](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#destroyed)
- [locked](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#locked)
- [writable](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#writable)
- [writableCorked](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#writablecorked)
- [writableEnded](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#writableended)
- [writableFinished](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#writablefinished)
- [writableHighWaterMark](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#writablehighwatermark)
- [writableLength](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#writablelength)
- [writableObjectMode](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#writableobjectmode)
- [captureRejectionSymbol](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#capturerejectionsymbol)
- [captureRejections](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#capturerejections)
- [defaultMaxListeners](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#defaultmaxlisteners)
- [errorMonitor](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#errormonitor)

### Methods

- [\_construct](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#_construct)
- [\_destroy](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#_destroy)
- [\_final](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#_final)
- [\_write](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#_write)
- [\_writev](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#_writev)
- [abort](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#abort)
- [addListener](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#addlistener)
- [close](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#close)
- [cork](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#cork)
- [destroy](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#destroy)
- [emit](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#emit)
- [end](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#end)
- [eventNames](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#eventnames)
- [getMaxListeners](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#getmaxlisteners)
- [getWriter](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#getwriter)
- [listenerCount](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#listenercount)
- [listeners](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#listeners)
- [off](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#off)
- [on](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#on)
- [once](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#once)
- [pipe](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#pipe)
- [prependListener](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#prependlistener)
- [prependOnceListener](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#prependoncelistener)
- [rawListeners](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#rawlisteners)
- [removeAllListeners](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#removealllisteners)
- [removeListener](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#removelistener)
- [setDefaultEncoding](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#setdefaultencoding)
- [setMaxListeners](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#setmaxlisteners)
- [uncork](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#uncork)
- [update](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#update)
- [verify](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#verify)
- [write](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#write)
- [getEventListeners](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#geteventlisteners)
- [listenerCount](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#listenercount-1)
- [on](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#on-1)
- [once](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#once-1)
- [setMaxListeners](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#setmaxlisteners-1)
...
The buffered data will be flushed when either the [uncork](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#uncork) or [end](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#end) methods are called.
...
Calling the [write](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#write) method after calling [end](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#end) will raise an error.
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#defaultmaxlisteners).
...
The `writable.uncork()` method flushes all data buffered since [cork](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#cork) was called.
...
If `object` is not a `KeyObject`, this function behaves as if`object` had been passed to [createPublicKey](https://oven-sh.github.io/bun-types/modules/node_crypto_.md#createpublickey). If it is an
...
recommended to encapsulate the logic into a `Readable` and use [pipe](https://oven-sh.github.io/bun-types/classes/node_crypto_.Verify.md#pipe). However, if calling `write()` is preferred, it is
